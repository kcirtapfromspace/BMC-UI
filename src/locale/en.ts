const translations = {
  ...
  network: {
    linkAggregation: "Link Aggregation (Bonding)",
    description: "Combine both Ethernet ports for increased bandwidth or failover.",
    status: "Status",
    active: "Active",
    inactive: "Inactive",
    currentMode: "Current Mode",
    slaveInterfaces: "Slave Interfaces",
    miiMonitor: "MII Monitor Interval",
    enableBonding: "Enable Link Aggregation",
    enableDescription: "Bond ge0 and ge1 into a single interface",
    bondingMode: "Bonding Mode",
    selectMode: "Select mode",
    saveReboot: "Save (Apply on Reboot)",
    saveApply: "Save & Apply Now",
    unsavedChanges: "You have unsaved changes.",
    configApplied: "Network configuration applied",
    configSaved: "Network configuration saved",
    applyDescription: "Network settings have been applied. Connection may be briefly interrupted.",
    saveDescription: "Changes saved. Reboot to apply.",
    saveFailed: "Failed to save network configuration",
  },
  ui: {
    cancel: "Cancel",
    continue: "Continue",
